...
@Component({
  selector: 'app-chatbotpopup',
  templateUrl: './chatbotpopup.component.html',
  styleUrls: ['./chatbotpopup.component.css']
})
export class ChatbotpopupComponent {
  ...
  constructor(private _NgbActiveModal: NgbActiveModal,private service:ChatService,private renderer:Renderer2,
    public dialogRef: MatDialogRef<ChatbotpopupComponent>,
